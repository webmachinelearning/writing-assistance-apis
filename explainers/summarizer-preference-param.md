...
The Writer and Rewriter APIs share the underlying spec infrastructure of the Summarizer API. These tasks also have varying requirements depending on the context:
